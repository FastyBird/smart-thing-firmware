...
class NTCSensor : public AnalogSensor {
    ...
    protected:
        ...
        uint32_t _beta = NTC_BETA;
        uint32_t _resistance_up = NTC_R_UP;
        uint32_t _resistance_down = NTC_R_DOWN;
        uint32_t _R0 = NTC_R0;
        double _T0 = NTC_T0;
