...
class BMP180Sensor : public I2CSensor {
    ...
    protected:
        ...
        uint8_t _read() {
            ...
            nice_delay(5);
            uint32_t t = i2c_read_uint16(_address, BMP180_REGISTER_TEMPDATA);
            ...
            nice_delay(26);
            uint32_t p1 = i2c_read_uint16(_address, BMP180_REGISTER_PRESSUREDATA);
            uint32_t p2 = i2c_read_uint8(_address, BMP180_REGISTER_PRESSUREDATA+2);
            ...
            x3 = ((x1 + x2) + 2) >> 2;
            uint32_t b4 = (_bmp180_calib.ac4 * (uint32_t) (x3 + 32768)) >> 15;
            uint32_t b7 = ((uint32_t) (p - b3) * (50000 >> _mode));
...
uint8_t BMP180Sensor::addresses[1] = {0x77};
